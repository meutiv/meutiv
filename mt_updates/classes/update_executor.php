...
//    }
    ...
    {
        $pluginRootPath = MT_DIR_PLUGIN . $pluginArr["module"] . DS;
    ...
    private function writeLog( $key )
    {
        ...
        if ( !empty($entries) )
        {
            $query = "INSERT INTO `{$this->dbPrefix}base_log` (`message`, `type`, `key`, `timeStamp`) VALUES (:message, 'mt_update', :key, :time)";
            try
            {
