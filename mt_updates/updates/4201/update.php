...
@mkdir(MT_DIR_PLUGIN_USERFILES.'base'.DS.'attachments');
@chmod(MT_DIR_PLUGIN_USERFILES.'base'.DS.'attachments', 0777);
@mkdir(MT_DIR_PLUGIN_USERFILES.'base'.DS.'attachments'.DS.'temp');
@chmod(MT_DIR_PLUGIN_USERFILES.'base'.DS.'attachments'.DS.'temp', 0777);
