...
if ( defined('MT_USE_AMAZON_S3_CLOUDFILES') && MT_USE_AMAZON_S3_CLOUDFILES || defined('MT_USE_CLOUDFILES') && MT_USE_CLOUDFILES )
{
    ...
    {
		if ( file_exists(MT_DIR_THEME_USERFILES . $theme->getCustomCssFileName()) && is_file(MT_DIR_THEME_USERFILES . $theme->getCustomCssFileName()) )
		{
        	$storage->copyFile(MT_DIR_THEME_USERFILES . $theme->getCustomCssFileName(), MT_DIR_THEME_USERFILES . $theme->getCustomCssFileName());
		}
    }
}
