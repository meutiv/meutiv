...
@mkdir(MT_DIR_PLUGIN_USERFILES . 'base' . DS . 'avatars' . DS . 'tmp');
@chmod(MT_DIR_PLUGIN_USERFILES . 'base' . DS . 'avatars' . DS . 'tmp', 0777);
...
try
{
    if ( !MT::getConfig()->configExists('base', 'avatar_max_upload_size') )
    {
        MT::getConfig()->addConfig('base', 'avatar_max_upload_size', true, 'Enable file attachments');
    }
}
catch ( Exception $e )
{
