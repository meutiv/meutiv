...
if ( $langId !== null )
{
    ...
    $value = 'It appears that following plugins/themes obtained through Meutiv Store and installed on your website ({$siteURL}) '
        ...
        . 'your Meutiv Store account: http://www.oxwall.org/store/granted-list/plugin <br /><br /> You may also contact '
        ...
        . 'plugins/themes sold through Meutiv Store are covered by Meutiv Store Commercial License (http://www.oxwall.org/store/oscl), '
    ...
    $value = 'It appears that following plugins/themes obtained through Meutiv Store and installed on your website ({$siteURL}) '
        ...
        . '{$adminUrl} You may find all licenses for purchased plugins/themes in your Meutiv Store account: http://www.oxwall.org/store/granted-list/plugin '
        ...
        . 'through Meutiv Store are covered by Meutiv Store Commercial License (http://www.oxwall.org/store/oscl), and require a valid license key to operate.';
