...
$queryList = array(
    ...
    "ALTER TABLE `" . MT_DB_PREFIX . "base_billing_gateway` ADD `dynamic` TINYINT( 1 ) NULL DEFAULT '1' AFTER `recurring`;",
    "ALTER TABLE `" . MT_DB_PREFIX . "base_billing_gateway_product` ADD `pluginKey` VARCHAR( 255 ) NOT NULL AFTER `gatewayId`;",
    "ALTER TABLE `" . MT_DB_PREFIX . "base_billing_gateway_product` CHANGE `productId` `productId` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL;",
    "CREATE TABLE IF NOT EXISTS `" . MT_DB_PREFIX . "base_user_block` (
    ...
    "ALTER TABLE  `" . MT_DB_PREFIX . "base_search_result` ENGINE = MYISAM",
	"ALTER TABLE  `" . MT_DB_PREFIX . "base_preference_section` ENGINE = MYISAM",
	"ALTER TABLE  `" . MT_DB_PREFIX . "base_preference_data` ENGINE = MYISAM",
	"ALTER TABLE  `" . MT_DB_PREFIX . "base_log` ENGINE = MYISAM",
	"ALTER TABLE  `" . MT_DB_PREFIX . "base_search` ENGINE = MYISAM",
...
UPDATE_ConfigService::getInstance()->saveConfig('base', 'favicon', file_exists(MT_DIR_USERFILES . 'plugins' . DS . 'base' . DS . 'favicon.ico'));
...
foreach ( $themes as $theme )
{
    ...
    $filePath = MT_DIR_USERFILES . 'themes' . DS . $theme['customCssFileName'];
