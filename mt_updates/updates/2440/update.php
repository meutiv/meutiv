...
$dirArray = array(
    MT_DIR_PLUGINFILES . 'admin' . DS . 'languages' . DS,
    MT_DIR_PLUGINFILES . 'admin' . DS . 'languages' . DS . 'export' . DS,
    MT_DIR_PLUGINFILES . 'admin' . DS . 'languages' . DS . 'import' . DS,
    MT_DIR_PLUGINFILES . 'admin' . DS . 'languages' . DS . 'tmp' . DS,
    MT_DIR_PLUGINFILES . 'ow' . DS,
    MT_DIR_PLUGINFILES . 'plugin' . DS
);
