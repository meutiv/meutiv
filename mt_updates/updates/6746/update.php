...
$navigation = MT::getNavigation();

try
{
    $navigation->addMenuItem(
        MT_Navigation::ADMIN_MOBILE,
        'mobile.admin.navigation',
        'mobile',
        'mobile_admin_navigation',
        MT_Navigation::VISIBLE_FOR_ALL);
}
catch ( Exception $e )
{
    $logger->addEntry(json_encode($e));
...
{
    $navigation->addMenuItem(
        MT_Navigation::MOBILE_HIDDEN,
        'base_member_dashboard',
        'mobile',
        'mobile_pages_dashboard',
        MT_Navigation::VISIBLE_FOR_MEMBER);
}
catch ( Exception $e )
{
    $logger->addEntry(json_encode($e));
...
$wurflDir = MT_DIR_LIB . 'wurfl' . DS;
$resourcesDir = MT_DIR_PLUGINFILES . 'base' . DS . 'wurfl' . DS;
