var OWM_NotificationsConsole = function(params) {
    ...
    this.consoleLoadMore = function($node) {
        ...
        MTM.loadComponent(
            "NOTIFICATIONS_MCMP_ConsoleItems", { limit: self.params.limit, exclude: exclude }, {
    ...
    MTM.bind("mobile.console_hide_notifications_load_more", function() {
    ...
    MTM.bind("mobile.hide_sidebar", function(data) {
        if (data.type == "right") {
            MTM.unbind("mobile.console_hide_notifications_load_more");
