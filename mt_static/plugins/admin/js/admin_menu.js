...
var AdminMenu = function(menuIdList, closedItems)
{
    ...
    var copen = function(nodeClass){
        var $context = $('.mt_admin_menu_cont .'+nodeClass);
        var link = $('a.arrow', $context);
        $('.mt_admin_menu_cont .'+nodeClass+' a.arrow').trigger('click');
    };
    ...
    $.each( this.menuIdList,
        function(i, o){
            $el = $('.mt_admin_menu_cont .'+this+' a.arrow');
            $('.mt_admin_menu_cont .'+this+' a.label_link').bind('click', {data:this}, function(e){copen(e.data.data)});
...
$('#top_link').click(function(){window.adsForm = new MT_FloatBox({$title:'Add Banner', $contents: $('#top_form'), width: '550px', height: '350px', class: 'mt_ic_add'})});
*/