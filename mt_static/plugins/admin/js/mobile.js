...
MOBILE.Navigation = (function() {
    ...
    Panel = function(panelKey, delegate) {
        ...
        this.options = {
            ...
            placeholder: 'mt_dnd_placeholder',
            clone: "original",
    ...
    $.extend(DefaultDelegate.prototype, {
        ...
        actionClick: function(panel, item, action) {
            ...
            if (action === "edit") {
                editFloatBox = MT.ajaxFloatBox("ADMIN_CMP_MobileNavigationItemSettings", [item.data("key")], {
                    "title": MT.getLanguageText("mobile", "admin_nav_settings_fb_title"),
                    "scope": {
    ...
    $.extend(NewDelegate.prototype, DefaultDelegate.prototype, {
        createItem: function(from) {
            ...
            return changeItem(item, {
                ...
                "title": MT.getLanguageText("mobile", "admin_nav_adding_message"),
                "locked": true,
