var mainSettings = function($responderUrl) {
    ...
    $("#verify_site_email_button").click(
        function() { self.floatbox = new MT_FloatBox({ $title: MT.getLanguageText('admin', 'verify_site_email'), $contents: $('#site-email-verify'), height: '170px', width: '350px' }); }
    );
