var MassMailing = function($responderUrl) {
    ...
    this.getCountMassMailingUsers = function() {
        if (this.sentRequest === false) {
            ...
            $('.total_members').html("<div style='height:30px;width:25px;' class='mt_preloader_content'></div>");
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('.total_members').html(MT.getLanguageText('admin', 'massmailing_total_members', params));
                }
            });
        }
    }
