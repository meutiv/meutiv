MT_Components_DragAndDrop = function() {
    ...
    $('#reset_position_btn').click(function() {
        if (confirm(MT.getLanguageText('base', 'widgets_reset_position_confirm'))) {
...
MT_Components_DragAndDrop.prototype = new componentDragAndDrop({
    ...
    clone: function(sortable, $cloningItem) {
        ...
        var $destItem = $('<div class="mt_dnd_preloader mt_preloader_content mt_stdmargin"></div>');
    ...
    handleStop: function(sortable, e, ui) {
        ...
        var $preloader = $('<div class="mt_dnd_preloader mt_preloader_content mt_stdmargin"></div>');
