                ...
                return create("a", {
                    ...
                    if (!$.suitUp.hasSelectedNodeParent("a")) {
                        ...
                        var floatBox = OWM.ajaxFloatBox("BASE_MCMP_InsertLink", [{ "linkText": $.suitUp.getSelectedText() }], {
                            "title": MT.getLanguageText('base', 'ws_button_label_link'),
                            "scope": {
            ...
            video: function(textarea, suitUpBlock) {
                return create("a", {
                    ...
                    var floatBox = OWM.ajaxFloatBox("BASE_MCMP_InsertVideo", [], {
                        "title": MT.getLanguageText('base', 'ws_button_label_video'),
                        "scope": {
                            "success": function(data) {
                                $.ajax({
                                    url: $.suitUp.embedUrl,
                                    ...
                                    success: function(response) {
                                        ...
                                        if (typeof data.type == "undefined" ||
                                            ...
                                            OWM.message(MT.getLanguageText('base', 'ws_error_video'), 'error');
                                            return;
                                        }
