...
AvatarUserSelect.prototype = {
                ...
                $('#' + data.linkId).click(
                    function() {
                        ...
                        if (uai == null) {
                            ...
                            $(this).addClass('mt_mild_green');
                        } else {
                            self.resultList.splice(uai, 1);
                            $(this).removeClass('mt_mild_green');
                        }
    ...
    submit: function() {
        if (this.resultList.length == 0) {
            MT.warning(MT.getLanguageText('base', 'avatar_user_select_empty_list_message'));
            return;
        }
        MT.trigger('base.avatar_user_list_select', [this.resultList]);
    }
}