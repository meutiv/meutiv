var MT_ChangePassword = function($params) {
    var self = this;
    ...
    this.validatePassword = function() {
        ...
        if (result.result == false) {
            var text = MT.getLanguageText('base', 'join_error_password_not_valid');
        ...
        //                             element.showError( MT.getLanguageText('base', 'join_error_password_not_valid') );
        //                        }
        //                    }
        //            } );
