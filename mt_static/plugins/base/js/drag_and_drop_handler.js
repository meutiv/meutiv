MT_Components_DragAndDropAjaxHandler = function(urlResponder, sharedData) {
    this.ajax = new MT_Component_Ajax(urlResponder);
    this.sharedData = sharedData;
};

MT_Components_DragAndDropAjaxHandler.prototype = {
