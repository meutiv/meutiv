MT_FriendRequest = function(itemKey, params) {
    var listLoaded = false;

    var model = MT.Console.getData(itemKey);
    ...
    this.accept = function(requestKey, userId) {
        ...
        $('#friend_request_accept_' + userId).addClass("mt_hidden");
        $('#friend_request_ignore_' + userId).addClass("mt_hidden");
