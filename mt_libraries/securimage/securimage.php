...
/**
 ...
 1.0.3
 - Removed shadmt_text from code which could cause an undefined property error due to removal from previous version
...
class Securimage {
	...
	*/
	...
	function __construct()
	{
		...
		$this->ttf_file = MT_DIR_LIB . 'securimage/AHGBold.ttf';
		...
		$this->signature_font  = MT_DIR_LIB . 'securimage/AHGBold.ttf';
