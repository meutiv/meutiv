 ...
 * @since 1.0
 */
class MT_HtmlDocument extends MT_Document
{
     ...
     *
     * @param MT_MasterPage $masterPage
     * @return MT_HtmlDocument
     */
    public function setMasterPage( MT_MasterPage $masterPage )
    {
    ...
    public function addScriptDeclaration( $script, $type = "text/javascript", $priority = null )
    {
        ...
        $event = new MT_Event('core.onAddScriptDeclaration', ['scriptHash' => $scriptHash, 'type' => $type], $script);
    ...
    public function render()
    {
        ...
        {
            $this->setTemplate(MT::getThemeManager()->getMasterPageTemplate('html_document'));
        }
        ...
        $assignArray = array(
            ...
            'pageBody' => $this->prependCode . $masterPageOutput . $this->appendCode . $jsData . MT_Document::APPEND_PLACEHOLDER,
            'bodyClass' => $this->bodyClass
        );

        $renderer = MT_ViewRenderer::getInstance();
    ...
    {
        MT::getEventManager()->trigger(new MT_Event($name, $params));
    }
}
