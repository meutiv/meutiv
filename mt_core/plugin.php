...
class MT_Plugin
{
    ...
    {
        return MT_DIR_PLUGIN_USERFILES . $this->getDirName() . DS;
    }
    ...
    {
        return MT_URL_PLUGIN_USERFILES . $this->getDirName() . "/";
    }

    public function getPluginFilesDir()
    {
        return MT_DIR_PLUGINFILES . $this->getDirName() . DS;
    }
    ...
    {
        return ($this->dto->isSystem() ? MT_DIR_SYSTEM_PLUGIN : MT_DIR_PLUGIN) . $this->getDirName() . DS;
    }
    ...
    {
        return MT_DIR_STATIC_PLUGIN . $this->getModuleName() . DS;
    }
    ...
    {
        return MT_URL_STATIC_PLUGINS . $this->getModuleName() . "/";
    }
