 ...
 * @package mt_core
 * @method static MT_ApiRequestHandler getInstance()
 * @since 1.0
 */
class MT_ApiRequestHandler extends MT_RequestHandler
{
    use MT_Singleton;
    ...
    {
        return $controller != null & $controller instanceof MT_ApiActionController;
    }
}
