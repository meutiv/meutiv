 ...
 * @since 1.0
 */
class MT_MasterPage extends MT_Renderable
{
    /*
    ...
    protected function init()
    {
        ...
        $currentTheme = MT::getThemeManager()->getCurrentTheme()->getDto();
        $values = json_decode(MT::getConfig()->getValue('base', 'master_page_theme_info'), true);
    ...
    public function onBeforeRender()
    {
        ...
        {
            $this->setTemplate(MT::getThemeManager()->getMasterPageTemplate(self::TEMPLATE_GENERAL));
        }
