 ...
 * @since 1.0
 */
abstract class MT_ApiActionController
{
    /**
    ...
    {
        if ( defined("MT_PROFILER_ENABLE") && MT_PROFILER_ENABLE ) {
            $this->assign('queryLog', MT::getDbo()->getQueryLog());
            $this->assign('queryCount', MT::getDbo()->getQueryCount());
            $this->assign('queryExecutionTime', MT::getDbo()->getTotalQueryExecTime());
