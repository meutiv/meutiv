...
/**
 * MT_Router is responsible for routing process, i.e. finding which controller and action should recieve request.
 * 
 * @author Sardar Madumarov <madumarov@gmail.com>
 * @package mt_core
 * @method static MT_Router getInstance()
 * @since 1.0
 */
class MT_Router
{
     ...
     * @return MT_Router
     */
    public function setDefaultRoute( MT_DefaultRoute $defaultRoute )
    {
     ...
     * @param MT_RouteAbstract $route
     * @return MT_Router
     */
    public function addRoute( MT_Route $route )
    {
