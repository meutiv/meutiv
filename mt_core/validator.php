 ...
 * @since 1.0
 */
class RequiredValidator extends MT_Validator
{
    /**
     * Constructor.
     *
    ...
    {
        $errorMessage = MT::getLanguage()->text('base', 'form_validator_required_error_message');
    ...
    /**
     * @see MT_Validator::getJsValidator()
     *
     * @return string
     */
    public function getJsValidator()
 ...
 * @since 1.0
 */
class WyswygRequiredValidator extends MT_Validator
{
    /**
     * Constructor.
     *
 ...
 * @since 1.0
 */
class StringValidator extends MT_Validator
{
    /**
     * String min length
     *
    ...
    public function __construct( $min = null, $max = null )
    {
        ...
        $errorMessage = MT::getLanguage()->text('base', 'form_validator_string_error_message');
 ...
 * @since 1.0
 */
class RegExpValidator extends MT_Validator
{
    /**
     * @var string
     */
    ...
    public function __construct( $pattern = null, $invert = false )
    {
        ...
        $errorMessage = MT::getLanguage()->text('base', 'form_validator_regexp_error_message');
...
class EmailValidator extends RegExpValidator
{
    ...
    public function __construct()
    {
        ...
        $errorMessage = MT::getLanguage()->text('base', 'form_validator_email_error_message');
...
class UrlValidator extends RegExpValidator
{
    ...
    public function __construct()
    {
        ...
        $errorMessage = MT::getLanguage()->text('base', 'form_validator_url_error_message');
 ...
 * @since 8.1
 */
class InArrayValidator extends MT_Validator
{
    /**
     * Predefined values
     *
    ...
    public function __construct( array $predefinedValues  = array() )
    {
        ...
        $this->errorMessage = MT::getLanguage()->text('base', 'form_validate_common_error_message');
    }
 ...
 * @since 1.0
 */
class IntValidator extends MT_Validator
{
    /**
     * @var int
     */
    ...
    public function __construct( $min = null, $max = null )
    {
        ...
        $errorMessage = MT::getLanguage()->text('base', 'form_validator_int_error_message');
...
/**
 * Meutiv: Open Source Community Software
 ...
 * @since 1.0
 */
class FloatValidator extends MT_Validator
{
    /**
     * @var float
     */
    ...
    public function __construct( $min = null, $max = null )
    {
        ...
        $errorMessage = MT::getLanguage()->text('base', 'form_validator_float_error_message');
 ...
 * @since 1.0
 */
class DateValidator extends MT_Validator
{
    /**
     * @var int
     */
    ...
    public function __construct( $minYear = null, $maxYear = null )
    {
        ...
        $errorMessage = MT::getLanguage()->text('base', 'form_validator_date_error_message');
 ...
 * @since 1.0
 */
class CaptchaValidator extends MT_Validator
{
    protected $jsObjectName = null;

    public function __construct()
    {
        $errorMessage = MT::getLanguage()->text('base', 'form_validator_captcha_error_message');
...
class RangeValidator extends MT_Validator
{
    /**
     * @var int
     */
    ...
    public function __construct()
    {
        $errorMessage = MT::getLanguage()->text('base', 'form_validator_range_error_message');
...
class AgeValidator extends MT_Validator
{
    /**
     * Minimal allowed age.
     *
