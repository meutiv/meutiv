 ...
 * @package mt_core
 * @method static MT_Session getInstance()
 * @since 1.0
 */
class MT_Session
{
    ...
    public function start()
    {
        ...
        {
            $_SESSION['session.home_url'] = MT_URL_HOME;
        }
        else if ( strcmp($_SESSION['session.home_url'], MT_URL_HOME) )
        {
            $this->regenerate();
        }

        $userAgent = MT::getRequest()->getUserAgentName();
