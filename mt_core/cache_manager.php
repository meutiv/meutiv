 ...
 * @package mt_core
 * @method static MT_CacheManager getInstance()
 * @since 1.0
 */
class MT_CacheManager
{
    use MT_Singleton;
    ...
    /**
     * @param MT_ICacheBackend $cacheBackend
     */
    public function setCacheBackend( MT_ICacheBackend $cacheBackend )
    {
