 ...
 * @since 1.0
 */
final class MT_Database
{
    //const DEFAULT_CACHE_LIFETIME = false;
    const NO_CACHE_ENTRY = "mt_db_no_cache_entry";
    ...
    private function execute( $sql, array $params = null )
    {
        ...
        MT::getEventManager()->trigger(new MT_Event("core.sql.exec_query", array("sql" => $sql, "params" => $params)));
    ...
    {
        return !MT_DEV_MODE && $this->useCashe && ( $expTime === false || $expTime > 0 );
    }
    ...
    private function getFromCache( $sql, $params, $cacheLifeTime )
    {
        ...
        $data = MT::getEventManager()->call("core.sql.get_query_result", array("sql" => $sql, "params" => $params));
    ...
    private function saveToCache( $result, $sql, $params, $cacheLifeTime, $tags )
    {
        ...
        MT::getEventManager()->trigger(new MT_Event("core.sql.set_query_result",
