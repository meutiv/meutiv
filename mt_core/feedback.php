 ...
 * @package mt_core
 * @method static MT_Feedback getInstance()
 * @since 1.0
 */
class MT_Feedback
{
    ...
    private function __construct()
    {
        ...
        if ( $session->isKeySet('mt_messages') )
        {
            $this->feedback = $session->get('mt_messages');
            $session->delete('mt_messages');
        }
        else
        {
            $this->feedback = array(
    ...
    public function __destruct()
    {
        ...
        {
            MT::getSession()->set('mt_messages', $this->feedback);
        }
    }
}
