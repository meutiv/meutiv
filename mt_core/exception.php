...
class Redirect404Exception extends InterceptException
{
    ...
    {
        $route = MT::getRouter()->getRoute('base_page_404');
...
class Redirect500Exception extends RedirectException
{
    ...
    public function __construct()
    {
        parent::__construct(MT_URL_HOME . '500.phtml', 500);
    }
}
...
class Redirect403Exception extends InterceptException
{
    ...
    public function __construct( $message = null )
    {
        $route = MT::getRouter()->getRoute('base_page_403');
...
class RedirectConfirmPageException extends RedirectException
{
    ...
    {
        parent::__construct(MT::getRequest()->buildUrlQueryString(MT::getRouter()->urlForRoute('base_page_confirm'), array('back_uri' => urlencode(MT::getRequest()->getRequestUri()))));
        MT::getSession()->set('baseConfirmPageMessage', $message);
    }
}
...
class RedirectAlertPageException extends RedirectException
{
    ...
    public function __construct( $message )
    {
        parent::__construct(MT::getRouter()->urlForRoute('base_page_alert'));
        MT::getSession()->set('baseAlertPageMessage', $message);
    }
}
...
class AuthenticateException extends RedirectException
{
    ...
    public function __construct()
    {
        parent::__construct(MT::getRequest()->buildUrlQueryString(MT::getRouter()->urlForRoute('static_sign_in'), array('back-uri' => urlencode(MT::getRequest()->getRequestUri()))));
    }
}
