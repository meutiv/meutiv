...
abstract class MT_BaseDao
{
    ...
    public function findListByExample( MT_Example $example, $cacheLifeTime = 0, $tags = array() )
    {
        if ( $example === null )
        {
    ...
    public function countByExample( MT_Example $example, $cacheLifeTime = 0, $tags = array() )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
    ...
    public function findObjectByExample( MT_Example $example, $cacheLifeTime = 0, $tags = array() )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
    ...
    public function deleteByExample( MT_Example $example )
    {
     ...
     *
     * @param MT_Entity $entity
     * 
     * @throws InvalidArgumentException
     */
    public function save( $entity )
    {
        if ( $entity === null || !($entity instanceof MT_Entity) )
        {
            throw new InvalidArgumentException('Argument must be instance of MT_Entity and cannot be null');
        }
    ...
    public function findIdByExample( MT_Example $example, $cacheLifeTime = 0, $tags = array() )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
    ...
    public function findIdListByExample( MT_Example $example, $cacheLifeTime = 0, $tags = array() )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
    ...
    protected function clearCache()
    {
        ...
        if ( $tagsToClear )
        {
            MT::getCacheManager()->clean($tagsToClear);
        }
    }
