...
class Form
{
    ...
    public function __construct( $name, $id = '' )
    {
        ...
        $this->setEmptyElementsErrorMessage(MT::getLanguage()->text('base', 'form_validate_common_error_message'));
    ...
    public function isValid( $data )
    {
        ...
        )
        {
            ...
            MT::getFeedback()->error(MT::getLanguage()->text("base", "invalid_csrf_token_error_message"));
        }
    ...
    public function render( $formContent, array $params = array() )
    {
        ...
        $jsString = " var form = new OwForm(" . json_encode($formInitParams) . ");window.owForms[form.name] = form;
			...
			if ( form.form ) 
			{
    			...
    			$(form.form).bind( 'submit', {form:form},
                        ...
                        MT.trigger('base.onFormReady.' + form.name, [], form);
                        MT.trigger('base.onFormReady', [form]);
		";
        ...
        MT::getDocument()->addOnloadScript($jsString, 10);
