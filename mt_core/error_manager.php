...
final class MT_ErrorManager
{
    ...
    public function setLogger( MT_Log $logger )
    {
        $this->logger = $logger;
    }
    ...
    private function handleDie( $data )
    {
        ...
        MT::getEventManager()->trigger(new MT_Event('core.emergency_exit', $data));
        exit;
    }
    ...
    private function handleRedirect( $data )
    {
        ...
        header('Location: ' . MT_URL_HOME . 'e500.php');
    }
