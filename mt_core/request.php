 ...
 * @package mt_core
 * @method static MT_Request getInstance()
 * @since 1.0
 */
class MT_Request
{
    ...
    public function getRequestUri()
    {
        if ( $this->uri === null )
        {
            $this->uri = UTIL_Url::getRealRequestUri(MT::getRouter()->getBaseUrl(), $_SERVER['REQUEST_URI']);
        }
...
//    }
    ...
    {
        $url = ( $url === null ) ? MT_URL_HOME . $this->getRequestUri() : trim($url);
