...
class MT_Log
{
     ...
     *
     * @param string $type
     * @param MT_LogWriter $logWriter
     */
    private function __construct( $type )
    {
        $this->type = $type;
        $this->logWriter = new BASE_CLASS_DbLogWriter();
        MT::getEventManager()->bind('core.exit', array($this, 'writeLog'));
        MT::getEventManager()->bind('core.emergency_exit', array($this, 'writeLog'));
    }
     ...
     * @param MT_LogWriter $logWriter
     */
    public function setLogWriter( MT_LogWriter $logWriter )
    {
