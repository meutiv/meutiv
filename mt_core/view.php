...
class MT_View
{
    ...
    {
        return MT::getEventManager()->trigger(new MT_Event($name, $params, $data));
    }
     ...
     * @return mixed
     */
    protected function triggerEventForObject( MT_Event $event )
    {
        return MT::getEventManager()->trigger($event);
    }
}
