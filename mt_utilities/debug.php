...
final class UTIL_Debug
{
    ...
    public static function varDump( $var, $exit = false )
    {
        ...
        $debugString = '
    	<div class="mt_debug_cont">
    		<div class="mt_debug_body">
    			<div class="mt_debug_cap vardump">MT Debug - Vardump</div>
    			<div>
    ...
    public static function printDebugMessage( $data )
    {
        ...
        $debugString = '
    		<div class="mt_debug_cont">
    			<div class="mt_debug_body">
    				<div class="mt_debug_cap ' . strtolower($data['type']) . '">MT Debug - ' . $data['type'] . '</div>
    				<table>
    					<tr>
    ...
    private static function addDebugStyles()
    {
        echo '
    	<style>
    		.mt_debug_cont{padding:15px 0;width:80%;margin:0 auto;}
    		.mt_debug_body{background:#fff;border:4px double;padding:5px;}
    		.mt_debug_cap{font:bold 13px Tahoma;font-family: sans-serif;color:#fff;padding:5px;border:1px solid #000;width:250px;margin-top:-20px;}
    		.mt_debug_body .notice{background:#fdf403;color:#555;}
    		.mt_debug_body .warning{background:#f8b423;color:#555;}
    		.mt_debug_body .error{background:#c10505;color:#fff;}
    		.mt_debug_body .exception{background:#093dd3;color:#fff;}
    		.mt_debug_body .vardump{background:#333;color:#fff;}
