...
class BOL_MailService
{
    ...
    private function __construct()
    {
        ...
        $siteName = MT::getConfig()->getValue('base', 'site_name');
        $siteEmail = MT::getConfig()->getValue('base', 'site_email');
        $senderSuffix = defined('MT_SENDER_MAIL_SUFFIX') ? MT_SENDER_MAIL_SUFFIX : null;
    ...
    {
        if ( MT::getConfig()->getValue('base', 'mail_smtp_enabled') )
        {
    ...
    public function send( BASE_CLASS_Mail $mail )
    {
        ...
        $event = new MT_Event('base.mail_service.send.check_mail_state', array(), $mailState);
