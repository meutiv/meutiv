...
class BOL_GeolocationService
{
    ...
    public function getCountryNameForCC3( $code )
    {
        ...
        return MT::getLanguage()->text('base', 'geolocation_country_name_' . $code);
    }
    ...
    // "LOAD DATA LOCAL INFILE '/home/nurlan/Downloads/ip-to-country.csv' INTO TABLE `mt_base_geolocation_ip2country` FIELDS TERMINATED BY ',' ENCLOSED BY '\"' LINES TERMINATED BY '\\r\\n' (`ipFrom`, `ipTo`, `cc2`, `cc3`, `name`)";
    //insert into mt_base_geolocation_country (`cc2`, `cc3`, `name`) select `cc2`, `cc3`, `name` from mt_base_geolocation_ip2country group by `cc3`
}