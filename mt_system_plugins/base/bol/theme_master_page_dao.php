 ...
 * @since 1.0
 */
class BOL_ThemeMasterPageDao extends MT_BaseDao
{
    ...
    {
        return MT_DB_PREFIX . 'base_theme_master_page';
    }
    ...
    public function findByThemeId( $themeId )
    {
        ...
        return $this->findListByExample($example, 24 * 3600, array(BOL_ThemeDao::CACHE_TAG_PAGE_LOAD_THEME, MT_CacheManager::TAG_OPTION_INSTANT_LOAD));
    }
