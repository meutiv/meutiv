...
class BOL_MobileNavigationService
{
    ...
    public function createEmptyItem( $menu, $order )
    {
        ...
        $this->editItem($menuItem, array(
            self::SETTING_LABEL => MT::getLanguage()->text("mobile", "admin_nav_default_menu_name"),
            self::SETTING_TITLE => MT::getLanguage()->text("mobile", "admin_nav_default_page_title"),
            self::SETTING_CONTENT => MT::getLanguage()->text("mobile", "admin_nav_default_page_content"),
