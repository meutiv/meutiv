 ...
 * @since 1.0
 */
class BOL_AuthorizationRoleDao extends MT_BaseDao
{
    const GUEST = 'guest';
    ...
    {
        return MT_DB_PREFIX . 'base_authorization_role';
    }
    ...
    public function findAll( $cacheLifeTime = 0, $tags = array() )
    {
        ...
        return $this->findListByExample($example, 3600 * 24, array(BOL_AuthorizationActionDao::CACHE_TAG_AUTHORIZATION, MT_CacheManager::TAG_OPTION_INSTANT_LOAD));
    }
}