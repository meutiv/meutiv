...
class BOL_SearchService
{
    ...
    const SEARCH_RESULT_ID_VARIABLE = "MT_SEARCH_RESULT_ID";
    ...
    public function saveSearchResult( array $idList )
    {
        ...
        $event = new MT_Event('base.after_save_search_result', array('searchDto' => $search, 'userIdList' => $idList), array());
    ...
    public function updateSearchResult( $id, array $idList )
    {
        ...
        $event = new MT_Event('base.after_update_search_result', array('userIdList' => $idList), array());
        MT::getEventManager()->trigger($event);
