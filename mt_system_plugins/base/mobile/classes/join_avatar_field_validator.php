...
class BASE_MCLASS_JoinAvatarFieldValidator extends BASE_CLASS_AvatarFieldValidator
{
    ...
    public function isValid( $value )
    {
        ...
        $allowedAvatarSize = MT::getConfig()->getValue('base', 'avatar_max_upload_size');
    ...
    public function getJsValidator()
    {
        ...
        if ( $this->required )
        {
            $allowedAvatarSize = MT::getConfig()->getValue('base', 'avatar_max_upload_size') * 1048576;
            ...
            if ( value == undefined || $.trim(value).length == 0 ) {
                ...
                throw " . json_encode( MT::getLanguage()->text('base', 'upload_file_max_upload_filesize_error') ) . ";
            }";
        }
