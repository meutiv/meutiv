 ...
 * @since 1.0
 */
class BASE_MCMP_InsertLink extends MT_MobileComponent
{
    /**
     * Class constructor
     * 
...
class InsertLinkForm extends Form
{
    ...
    public function __construct()
    {
        ...
        $titleField->setRequired(true)->setHasInvitation(true)->setInvitation(MT::getLanguage()->text('base', 'ws_link_text_label'));

        $sValidator = new StringValidator(self::MIN_TITLE_LENGTH, self::MAX_TITLE_LENGTH);
        $sValidator->setErrorMessage(MT::getLanguage()->
        ...
        $linkField->setRequired(true)->setHasInvitation(true)->setInvitation(MT::getLanguage()->text('base', 'ws_link_url_label'));
