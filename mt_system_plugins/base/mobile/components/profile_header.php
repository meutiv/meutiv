...
class BASE_MCMP_ProfileHeader extends MT_MobileComponent
{
    /**
     *
     * @var BOL_User
    ...
    public function onBeforeRender() 
    {
        ...
        if ( MT::getUser()->getId() == $this->user->getId() )
        {
            $owner = true;
        }
        ...
        $this->addComponent('toolbar', MT::getClassInstance("BASE_MCMP_ProfileActionToolbar", $this->user->id));
        ...
        $permissions = MT::getEventManager()->getInstance()->call('privacy_check_permission_for_user_list', $eventParams);
