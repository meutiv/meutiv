...
class BASE_MCMP_ProfileAbout extends MT_MobileComponent
{
    /**
     *
     * @var BOL_User
    ...
    public function onBeforeRender()
    {
        ...
        $this->assign('aboutUrl', MT::getRouter()->urlForRoute('base_about_profile', array('username' => $this->user->username)));
