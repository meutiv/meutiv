 ...
 * @since 1.0
 */
class BASE_MCTRL_UserList extends MT_MobileActionController
{
    ...
    public function __construct()
    {
        ...
        $this->setPageTitle(MT::getLanguage()->text('base', 'users_browse_page_heading'));
    ...
    public function index( $params )
    {
        ...
        MT::getDocument()->addScript(MT::getPluginManager()->getPlugin('base')->getStaticJsUrl().'mobile_user_list.js');
        ...
        MT::getDocument()->addOnloadScript(" 
            window.mobileUserList = new MT_UserList(".  json_encode(array(
                    ...
                    'responderUrl' => MT::getRouter()->urlForRoute('base_user_lists_responder')
                )).");
        ", 50);
    }
