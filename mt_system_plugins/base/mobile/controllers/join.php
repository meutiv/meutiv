...
class BASE_MCTRL_Join extends BASE_CTRL_Join
{
    ...
    {        
        ...
        $this->responderUrl = MT::getRouter()->urlFor("BASE_MCTRL_Join", "ajaxResponder");
    }
    ...
    public function index( $params )
    {
        ...
        {
            $this->redirect(MT::getRouter()->urlForRoute('base_index'));
        }
        
        parent::index($params);
        $this->setTemplate(MT::getPluginManager()->getPlugin('base')->getMobileCtrlViewDir() . 'join_index.html');
        ...
        if( !empty($form) )
        {
            $this->joinForm->setAction(MT::getRouter()->urlFor('BASE_MCTRL_Join', 'joinFormSubmit', $urlParams));
