...
class BASE_MCTRL_CompleteProfile extends BASE_CTRL_CompleteProfile
{
    ...
    public function fillAccountType( $params )
    {
        ...
        $this->setTemplate(MT::getPluginManager()->getPlugin('base')->getMobileCtrlViewDir() . 'complete_profile_fill_account_type.html');
    ...
    public function fillRequiredQuestions( $params )
    {
        ...
        $this->setTemplate(MT::getPluginManager()->getPlugin('base')->getMobileCtrlViewDir() . 'complete_profile_fill_required_questions.html');

        $form = $this->getForm('requiredQuestionsForm');

        $questions = $this->questionService->getEmptyRequiredQuestionsList(MT::getUser()->getId());
