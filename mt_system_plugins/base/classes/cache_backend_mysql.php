 ...
 * @since 1.0
 */
class BASE_CLASS_CacheBackendMysql implements MT_ICacheBackend
{
    /**
     * @var array
     */
    ...
    public function __construct( MT_Database $dbo )
    {
        $this->dbo = $dbo;
    ...
    public function clean( array $tags, $mode )
    {
        ...
        switch ( $mode )
        {
            ...
            case MT_CacheManager::CLEAN_OLD:
    ...
    public function save( $data, $key, array $tags = array(), $lifeTime )
    {
        ...
        $optionIndex = array_search(MT_CacheManager::TAG_OPTION_INSTANT_LOAD, $tags);
    ...
    {
        return MT_DB_PREFIX . 'base_cache';
    }

    private function getTagsTableName()
    {
        return MT_DB_PREFIX . 'base_cache_tag';
    }
}