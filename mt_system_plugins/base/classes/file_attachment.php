 ...
 * @since 1.0
 */
class BASE_CLASS_FileAttachment extends MT_Component
{
    private $uid;
    ...
    public function onBeforeRender()
    {
        ...
        $params = array(
            'uid' => $this->uid,
            'submitUrl' => MT::getRouter()->urlFor('BASE_CTRL_Attachment', 'addFile'),
            'deleteUrl' => MT::getRouter()->urlFor('BASE_CTRL_Attachment', 'deleteFile'),
        ...
        MT::getDocument()->addOnloadScript("owFileAttachments['" . $this->uid . "'] = new OWFileAttachment(" . json_encode($params) . ");");
