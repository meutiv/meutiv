 ...
 * @since 1.0
 */
require( MT_DIR_LIB . 'rackspace_cloudfiles' . DS . 'cloudfiles.php');

class BASE_CLASS_CloudStorage implements MT_Storage
{
    ...
    public function __construct()
    {
        ...
        $this->auth = new CF_Authentication(MT_CLOUDFILES_USER, MT_CLOUDFILES_API_KEY);
        $this->auth->authenticate();
        $this->connection = new CF_Connection($this->auth);
        $this->container = $this->connection->get_container(MT_CLOUDFILES_CONTAINER);
    }
