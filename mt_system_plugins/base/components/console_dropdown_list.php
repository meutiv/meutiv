...
class BASE_CMP_ConsoleDropdownList extends BASE_CMP_ConsoleDropdownClick
{
    ...
    public function __construct($label, $key)
    {
        ...
        $template = MT::getPluginManager()->getPlugin('BASE')->getCmpViewDir() . 'console_dropdown_list.html';
    ...
    protected function initJs()
    {
        ...
        $js->addScript('MT.Console.addItem(new MT_ConsoleDropdownList({$uniqId}, {$contentIniqId}), {$key});', array(
