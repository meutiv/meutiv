...
class BASE_CMP_ContentPresenter extends MT_Component
{
...
class BASE_ContentPresenter extends MT_Component
{
    ...
    public function __construct( $content, $displayFormat ) 
    {
        ...
        $this->setTemplate(MT::getPluginManager()->getPlugin("base")
    ...
    public function onBeforeRender() 
    {
        ...
        $event = new MT_Event("content.before_presenter_render", array(
    ...
    protected function prepare() 
    {
        ...
        if ( $this->content['html'] )
        {
            ...
            $js->addScript('$("[data-action=play]", "#" + {$uniqId}).click(function(e) { '
                    ...
                    . '$(".mt_newsfeed_oembed_atch", "#" + {$uniqId}).addClass("mt_video_playing"); '
                    . '$(".mt_newsfeed_item_picture", "#" + {$uniqId}).html({$embed});'
                    . 'return false; });', array(
                "uniqId" => $this->uniqId,
                "embed" => $code
            ));
