 ...
 * @since 1.0
 */
class BASE_CMP_GiveUserRole extends MT_Component
{
    ...
    public function __construct( $userId )
    {
        ...
        if ( !MT::getUser()->isAuthorized('base') || $user === null )
        {
        ...
        $form->setAjax(true);
        $form->setAction(MT::getRouter()->urlFor('BASE_CTRL_User', 'updateUserRoles'));
        ...
        foreach ( $roleList as $role )
        {
            ...
            $field->setLabel(MT::getLanguage()->text('base', 'authorization_role_' . $role->getName()));
