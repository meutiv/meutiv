...
class BASE_CMP_DragAndDropFrontendPanel extends BASE_CMP_DragAndDropPanel
{
    ...
    public function onBeforeRender()
    {
        ...
        {
            $this->initializeJs($this->responderController, 'MT_Components_DragAndDrop', $this->sharedData);

            $jsDragAndDropUrl = MT::getPluginManager()->getPlugin('BASE')->getStaticJsUrl() . 'drag_and_drop.js';
