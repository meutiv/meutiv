...
class BASE_CMP_ProfileWallWidget extends BASE_CLASS_Widget
{
    ...
    public static function getSettingList()
    {
        ...
        $settingList['comments_count'] = array(
            ...
            'label' => MT::getLanguage()->text('base', 'cmp_widget_wall_comments_count'),
        ...
        $settingList['display_mode'] = array(
            'presentation' => self::PRESENTATION_SELECT,
            'label' => MT::getLanguage()->text('base', 'cmp_widget_wall_comments_mode'),
            'optionList' => array(
                '1' => MT::getLanguage()->text('base', 'cmp_widget_wall_comments_mode_option_1'),
                '2' => MT::getLanguage()->text('base', 'cmp_widget_wall_comments_mode_option_2')
            ),
            'value' => 2
        );
    ...
    public static function getStandardSettingValueList()
    {
        return array(
            ...
            self::SETTING_TITLE => MT::getLanguage()->text('base', 'comments_widget_label'),
