 ...
 * @since 1.0
 */
class BASE_CMP_AjaxOembedAttachment extends MT_Component
{
    ...
    public function initJs()
    {
        ...
        $js->newObject(array('MT_AttachmentItemColletction', $this->uniqId), 'MT_Attachment', array($this->uniqId, $this->oembed));
