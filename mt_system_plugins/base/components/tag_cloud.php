 ...
 * @since 1.0
 */
class BASE_CMP_TagCloud extends MT_Component
{
    /**
     * @var string
     */
    ...
    public function onBeforeRender()
    {
        ...
        foreach ( $list as $key => $value )
        {
            ...
            $tags[$key]['url'] = ($this->routeName === null) ? MT::getRequest()->buildUrlQueryString($this->url, array('tag' => $value['label'])) : MT::getRouter()->urlForRoute($this->routeName, array('tag' => $value['label']));
