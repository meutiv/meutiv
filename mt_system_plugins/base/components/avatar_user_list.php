 ...
 * @since 1.0
 */
class BASE_CMP_AvatarUserList extends MT_Component
{
    const CSS_CLASS_MINI_AVATAR = 'mt_mini_avatar';
    ...
    public function onBeforeRender()
    {
        ...
        $event = new MT_Event('bookmarks.is_mark', array(), $avatars);
        ...
        {
            $this->assign('view_more_array', array('url' => $this->viewMoreUrl, 'title' => MT::getLanguage()->text('base', 'view_more_label')));
        }
