...
class BASE_CMP_DragAndDropAdminPanel extends BASE_CMP_DragAndDropPanel
{
    ...
    public function __construct( $placeName, array $componentList, $template )
    {
        ...
        $jsDragAndDropUrl = MT::getPluginManager()->getPlugin('ADMIN')->getStaticJsUrl() . 'drag_and_drop.js';
        MT::getDocument()->addScript($jsDragAndDropUrl);
    ...
    public function onBeforeRender()
    {
        ...
        $this->initializeJs('BASE_CTRL_AjaxComponentAdminPanel', 'MT_Components_DragAndDrop', $this->sharedData);
    }
}