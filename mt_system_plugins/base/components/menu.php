 ...
 * @since 1.0
 */
class BASE_CMP_Menu extends MT_Component
{
    /**
     * @var array
     */
    ...
    public function __construct( $menuItems = array() )
    {
        ...
        $this->setTemplate(MT::getPluginManager()->getPlugin('base')->getCmpViewDir() . 'menu.html');
    }
    ...
    public function onBeforeRender()
    {
        ...
        {
            $menuItem->activate(MT::getRouter()->getBaseUrl() . MT::getRequest()->getRequestUri());
            $arrayToAssign[] = $this->getItemViewData($menuItem);
        }

        $this->assign('class', 'mt_' . MT_Autoload::getInstance()->classToFilename(get_class($this), false));
