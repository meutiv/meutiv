 ...
 * @since 1.7.6
 */
class BASE_CMP_SiteStatistic extends MT_Component
{
    /**
     * Chart Id
     *
    ...
    public function onBeforeRender()
    {
        ...
        MT::getDocument()->addScript(MT::getPluginManager()->getPlugin('base')->getStaticJsUrl() . 'chart.js');
    }
    ...
    protected function getHours()
    {
        ...
        $militaryTime = (bool) MT::getConfig()->getValue('base', 'military_time');
