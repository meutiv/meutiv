 ...
 * @since 1.0
 */
//class BASE_CMP_AjaxSignIn extends MT_Component
//{
...
//        $form->setAjax();
//        $form->setAction(MT::getRouter()->urlFor('BASE_CTRL_User', 'ajaxSignIn'));
//        $form->bindJsFunction(Form::BIND_SUCCESS, 'function(data){if( data.result ){MT.info(data.message);setTimeout(function(){window.location.reload();}, 1000);}else{MT.error(data.message);}}');
//        $this->addForm($form);
//        $this->assign('forgot_url', MT::getRouter()->urlForRoute('base_forgot_password'));
//        $this->assign('buttonList', implode('', $this->getRemoteAuthButtonList()));
//    }
//
//    private function getRemoteAuthButtonList()
//    {
//        $items = MT::getRegistry()->getArray(self::HOOK_REMOTE_AUTH_BUTTON_LIST);
//
//        if ( empty($items) )
//        {
//            return array();
