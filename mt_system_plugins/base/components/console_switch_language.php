...
public function __construct()
    {
        ...
        $template = MT::getPluginManager()->getPlugin('BASE')->getCmpViewDir() . 'console_switch_language.html';
        ...
        foreach($languages as $id=>$language)
        {
            if ( $language->status == 'active' )
            {
                ...
                $active_lang = array(
                    ...
                    'tag'=>$language->tag,
                    'class'=>"mt_console_lang{$tag['country']}",
                    'url'=> MT::getRequest()->buildUrlQueryString(null, array( "language_id"=>$language->id ) ),
                    'is_current'=>false
                    );
                ...
                if ( $session_language_id == $language->id )
                {
                        ...
                        $this->assign('class', "mt_console_lang{$tag['country']}");
                }
