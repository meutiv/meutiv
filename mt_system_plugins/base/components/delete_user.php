 ...
 * @since 1.0
 */
class BASE_CMP_DeleteUser extends MT_Component
{
    ...
    public function __construct( $params = array() )
    {
        ...
        $rspUrl = MT::getRouter()->urlFor('BASE_CTRL_User', 'deleteUser', array(
            'user-id' => $userId
        ));

        $rspUrl = MT::getRequest()->buildUrlQueryString($rspUrl, array(
