 ...
 * @since 1.0
 */
class BASE_CMP_Rate extends MT_Component
{
    ...
    public function __construct( $pluginKey, $entityType, $entityId, $ownerId )
    {
        ...
        {
            $userRateItem = $service->findRate($entityId, $entityType, MT::getUser()->getId());
        ...
        $jsParamsArray = array(
            ...
            'itemsCount' => $maxRate,
            'respondUrl' => MT::getRouter()->urlFor('BASE_CTRL_Rate', 'updateRate'),
            'ownerId' => $ownerId
        );

        MT::getDocument()->addOnloadScript("var rate$cmpId = new OwRate(" . json_encode($jsParamsArray) . "); rate$cmpId.init();");
    }
}