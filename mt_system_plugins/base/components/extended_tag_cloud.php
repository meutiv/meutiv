 ...
 * @since 1.0
 */
class BASE_CMP_ExtendedTagCloud extends MT_Component
{
    /**
     * @var integer
     */
    ...
    /**
     * @see MT_Rendarable::onBeforeRender
     */
    public function onBeforeRender()
    {
        ...
        {
            $tags[$key]['url'] = ($this->routeName === null) ? MT::getRequest()->buildUrlQueryString($this->url, array('tag' => $value['tagLabel'])) : MT::getRouter()->urlForRoute($this->routeName, array('tag' => $value['tagLabel']));
