...
class BASE_CMP_UserListWidget extends BASE_CMP_UsersWidget
{
    public function getData( BASE_CLASS_WidgetParameter $params )
    {
        ...
        $toolbar = array(
            'latest' => array(
                'label' => MT::getLanguage()->text('base', 'view_all'),
                'href' => MT::getRouter()->urlForRoute('base_user_lists', array('list' => 'latest'))
            ),
            'online' => array(
                'label' => MT::getLanguage()->text('base', 'view_all'),
                'href' => MT::getRouter()->urlForRoute('base_user_lists', array('list' => 'online'))
            ),
            'featured' => array(
                'label' => MT::getLanguage()->text('base', 'view_all'),
                'href' => MT::getRouter()->urlForRoute('base_user_lists', array('list' => 'featured'))
            )
        );
        ...
        $event = new MT_Event('base.userList.onToolbarReady', array(), $resultList);
    ...
    public static function getSettingList()
    {
        ...
        $settingList['count'] = array(
            'presentation' => 'number',
            'label' => MT::getLanguage()->text('base', 'user_list_widget_settings_count'),
            'value' => '9'
        );
    ...
    {
        return array(
            self::SETTING_TITLE => MT::getLanguage()->text('base', 'user_list_widget_settings_title'),
