...
class BASE_CMP_AboutMeWidget extends BASE_CLASS_Widget
{
    ...
    public function __construct( BASE_CLASS_WidgetParameter $param )
    {
        ...
        if ( $param->additionalParamList['entityId'] == MT::getUser()->getId() )
        {
    ...
    {
        return array(
            self::SETTING_TITLE => MT::getLanguage()->text('base', 'about_me_widget_default_title'),
...
class AboutMeForm extends Form
{
    ...
    public function __construct( $widgetUniqName = null, $content = null )
    {
        ...
        $this->setAjax(true);
        $this->setAction(MT::getRouter()->urlFor('BASE_CTRL_ComponentPanel', 'ajaxSaveAboutMe'));

        $input = new Textarea('about_me');
        $input->addAttribute('style', 'width: 93%');
        $input->setId('about_me_widget_input');
        $input->setHasInvitation(true);
        $input->setInvitation(MT::getLanguage()->text('base', 'about_me_widget_inv_text'));
        ...
        //$submit->setLabel(MT::getLanguage()->text('base', 'widget_about_me_save_btn'));
    ...
    public function process( $data )
    {
        ...
        return array('message' => MT::getLanguage()->text('base', 'about_me_widget_content_saved'));
    }
}
