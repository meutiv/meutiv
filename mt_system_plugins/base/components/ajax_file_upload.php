 ...
 * @since 1.7.5
 */
class BASE_CMP_AjaxFileUpload extends MT_Component
{
    public function __construct( $url = null )
    {
        ...
        $document->addScriptDeclarationBeforeIncludes(
            UTIL_JsGenerator::composeJsString(';window.ajaxFileUploadParams = {};
                ...
                array(
                    'url' => MT::getRouter()->urlForRoute('admin.ajax_upload'),
                    'size' => BOL_FileService::getInstance()->getUploadMaxFilesizeBytes(),
                    'deleteAction' => MT::getRouter()->urlForRoute('admin.ajax_upload_delete')
                )
            )
        );
