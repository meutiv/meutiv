 ...
 * @since 1.0
 */
class BASE_CMP_OembedAttachment extends MT_Component
{
    ...
    public function initJs()
    {
        ...
        $js->addScript('$(".mt_oembed_video_cover", "#" + {$uniqId}).click(function() { '
                . '$(".two_column", "#" + {$uniqId}).addClass("mt_video_playing"); '
                . '$(".attachment_left", "#" + {$uniqId}).html({$embed});'
                . 'MT.trigger("base.comment_video_play", {});'
                . 'return false; });', array(
            "uniqId" => $this->uniqId,
            "embed" => $code
        ));
