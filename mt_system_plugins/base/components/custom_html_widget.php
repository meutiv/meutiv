...
class BASE_CMP_CustomHtmlWidget extends BASE_CLASS_Widget
{
    ...
    public static function getSettingList()
    {
        ...
        $settingList['content'] = array(
            ...
            'label' => MT::getLanguage()->text('base', 'custom_html_widget_content_label'),
            'value' => ''
        );

        $settingList['nl_to_br'] = array(
            'presentation' => self::PRESENTATION_CHECKBOX,
            'label' => MT::getLanguage()->text('base', 'custom_html_widget_nl2br_label'),
            'value' => '0'
        );
    ...
    {
        if ( $place != BOL_ComponentService::PLACE_DASHBOARD && !MT::getUser()->isAdmin() )
        {
    ...
    {
        return array(
            self::SETTING_TITLE => MT::getLanguage()->text('base', 'custom_html_widget_default_title')
        );
    }
