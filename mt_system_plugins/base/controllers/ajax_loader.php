 ...
 * @since 1.0
 */
class BASE_CTRL_AjaxLoader extends MT_ActionController
{
    ...
    public function component()
    {
        ...
        $cmp = MT::getClassInstanceArray($cmpClass, $params);
        $responce = $this->getComponentMarkup($cmp);

        exit(json_encode($responce));
    }

    protected function getComponentMarkup( MT_Component $cmp )
    {
