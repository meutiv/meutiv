...
class ADMIN_CLASS_SeoMetaForm extends Form
{
    ...
    public function processData( $post )
    {
        ...
        if( $this->isValid($post) ){
            ...
            MT_DeveloperTools::getInstance()->clearLanguagesCache();
...
class MetaInfoValidator extends MT_Validator
{
    /**
     * Class constructor
     *
    ...
    {
        $this->setErrorMessage(MT::getLanguage()->text("base", "invalid_meta_error_message"));
    }
