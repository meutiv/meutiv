 ...
 * @since 1.0
 */
class ADMIN_CMP_LangEdit extends MT_Component
{
    /**
     * BOL_LanguageService
     */
    ...
    public function __construct( $langId )
    {
        ...
        $form->setAjax();
        $form->setAction(MT::getRouter()->urlFor('ADMIN_CTRL_Languages', 'langEditFormResponder'));
        ...
        $isoTagValidator->setErrorMessage(MT::getLanguage()->text('admin', 'incorrect_iso_tag_format'));
