 ...
 * @since 1.0
 */
class ADMIN_CMP_MobileNavigation extends MT_Component
{
    ...
    public function __construct() 
    {
        ...
        MT_ViewRenderer::getInstance()->registerFunction('dnd_item', array($this, 'tplItem'));
    }
    ...
    {
        $adminJsUrl = MT::getPluginManager()->getPlugin("admin")->getStaticJsUrl();
        $baseJsUrl = MT::getPluginManager()->getPlugin("base")->getStaticJsUrl();
        
        MT::getDocument()->addScript($baseJsUrl . "jquery-ui.min.js");
        MT::getDocument()->addScript($adminJsUrl . "mobile.js");
        ...
        MT::getLanguage()->addKeyForJs("mobile", "admin_nav_adding_message");
        MT::getLanguage()->addKeyForJs("mobile", "admin_nav_settings_fb_title");
    }
