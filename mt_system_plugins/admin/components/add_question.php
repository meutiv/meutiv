...
class ADMIN_CMP_AddQuestion extends MT_Component
{
    ...
    public function __construct()
    {
        ...
        $addForm = MT::getClassInstance('ADMIN_CLASS_AddQuestionForm', 'qst_add_form', MT::getRouter()->urlFor("ADMIN_CTRL_Questions", "ajaxResponder"));
       ...
       MT.bind("admin.questions_edit_question_value", function(data) {
            ...
            if ( storage && data )
            {
                ...
                $.each(data , function( key, value ) {
                    ...
                    if ( match && match[0] && value )
                    {
                        ...
                        if ( langId == ' . json_encode(MT::getLanguage()->getCurrentId()) . ' )
                        {
        ...
        MT.bind("question.value.add", function(data) {
            var currentLang = ' . json_encode(MT::getLanguage()->getCurrentId()) . ';
        ...
        MT.bind("question.value.delete", function(data) {
        ...
        $("form[name=qst_add_form]").on( "dblclick", ".values_list .tag .label", function() {
            ...
            MT.ajaxFloatBox("ADMIN_CMP_EditQuestionValueLabel", [value, data[value]], { title: ' . json_encode(MT::getLanguage()->text('base', 'questions_edit_question_value_title')) . ' } );
        } );
