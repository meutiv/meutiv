...
class ADMIN_CMP_EditQuestionValueLabel extends MT_Component
{
    public function  __construct( $value, $languageData )
    {
        parent::__construct();
        $this->setTemplate(MT::getPluginManager()->getPlugin('base')->getCmpViewDir() . 'language_value_edit.html');
        ...
        $jsString = '
           ...
           owForms[{$formName}].submitForm = function(){
            ...
            owForms[{$formName}].bind("submit", function($data){
                MT.trigger("admin.questions_edit_question_value", [$data], this);
                return false;
            })';
