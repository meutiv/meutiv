 ...
 * @since 1.2.7
 */
class ADMIN_CMP_BillingGatewayProducts extends MT_Component
{
    public function __construct( $params = array() )
    {
        ...
        $this->assign('actionUrl', MT::getRouter()->urlFor('BASE_CTRL_Billing', 'saveGatewayProduct'));
        $this->assign('backUrl', urlencode(MT::getRouter()->getBaseUrl() . MT::getRouter()->getUri()));
    }
}