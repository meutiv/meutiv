...
class ADMIN_CMP_AddQuestionSection extends MT_Component
{
    public function __construct()
    {
        ...
        $addSectionForm->setAction(MT::getRouter()->urlFor("ADMIN_CTRL_Questions", "ajaxResponder"));
        ...
        $qstSectionName->addAttribute('class', 'mt_text');
