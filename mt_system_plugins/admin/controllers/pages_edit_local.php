...
class ADMIN_CTRL_PagesEditLocal extends ADMIN_CTRL_Abstract
{
    ...
    public function __construct()
    {
        ...
        $this->assign('homeUrl', MT::getRouter()->getBaseUrl());
    }
...
//--
            ...
            $uri = str_replace(UTIL_String::removeFirstAndLastSlashes(MT::getRouter()->getBaseUrl()), '', UTIL_String::removeFirstAndLastSlashes($data['url']));
...
//~
            ...
            $adminPlugin = MT::getPluginManager()->getPlugin('admin');

            MT::getFeedback()->info(MT::getLanguage()->text($adminPlugin->getKey(), 'updated_msg'));
...
//--
    ...
    public function delete( $params )
    {
        ...
        $this->redirect(MT::getRouter()->urlForRoute('admin_pages_main'));
    }
}
...
class EditLocalPageForm extends Form
{
    ...
    public function __construct( $name, BOL_MenuItem $menu )
    {
        ...
        $language = MT_Language::getInstance();
        $languageService = BOL_LanguageService::getInstance();
        ...
        $this->addElement(
                ...
                ->setLabel(MT::getLanguage()->text('admin', 'pages_edit_local_menu_name'))
                ->setRequired()
        );
        ...
        $this->addElement(
                ...
                ->setLabel(MT::getLanguage()->text('admin', 'pages_edit_local_page_title'))
                ->setRequired(true)
        );
        ...
        $this->addElement(
                ...
                ->setLabel(MT::getLanguage()->text('admin', 'pages_edit_local_page_url'))
                ->setRequired(true)
        );
        ...
        $this->addElement(
                ...
                ->setValue($values)
                ->setLabel(MT::getLanguage()->text('admin', 'pages_edit_local_visible_for'))
        );
        ...
        $this->addElement(
            $metaTagsTextarea->setLabel(MT::getLanguage()->text("base", "pages_page_meta_keywords_label"))
                ->setValue($langValue)
                ->setDescription(MT::getLanguage()->text('base', 'pages_page_meta_keywords_desc'))
        );
        ...
        $this->addElement(
            $metaTagsTextarea->setLabel(MT::getLanguage()->text("base", "pages_page_meta_desc_label"))
                ->setValue($langValue)
                ->setDescription(MT::getLanguage()->text('base', 'pages_page_meta_desc_desc'))
        );
        ...
        $this->addElement(
                $contentTextArea->setLabel(MT::getLanguage()->text('admin', 'pages_edit_local_page_content'))
                ->setValue($langValue)
                ->setId('content')
        );
