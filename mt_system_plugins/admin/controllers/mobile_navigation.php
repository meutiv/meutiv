...
class ADMIN_CTRL_MobileNavigation extends ADMIN_CTRL_Abstract
{
    ...
    protected function setup( ADMIN_CMP_MobileNavigation $dnd )
    {
        ...
        $responderUrl = MT::getRouter()->urlFor("ADMIN_CTRL_MobileNavigation", "rsp");
        ...
        $dnd->setupPanel("new", array(
            "items" => array(
                array("key" => "new-item", "title" => MT::getLanguage()->text("mobile", "admin_nav_new_item_label"))
            )
        ));
        ...
        $template = MT::getPluginManager()->getPlugin("admin")->getCmpViewDir() . "mobile_navigation.html";
