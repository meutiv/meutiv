...
class EditExternalPageForm extends Form
{
    ...
    public function __construct( $name, BOL_MenuItem $menu )
    {
        ...
        $this->addElement(
                ...
                ->setLabel(MT::getLanguage()->text('admin', 'pages_edit_external_menu_name_label'))
                ->setRequired(true)
        );
        ...
        $this->addElement(
                ...
                ->setLabel(MT::getLanguage()->text('admin', 'pages_edit_external_url_label'))
                ->setRequired(true)
        );
        ...
        $this->addElement(
                ...
                ->setValue($values)
                ->setLabel(MT::getLanguage()->text('admin', 'pages_edit_external_visible_for'))
        );
