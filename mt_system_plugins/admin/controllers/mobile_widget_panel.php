...
class ADMIN_CTRL_MobileWidgetPanel extends ADMIN_CTRL_Abstract
{
    ...
    {
        $template = MT::getPluginManager()->getPlugin("admin")->getCtrlViewDir() . "mobile_drag_and_drop.html";
    ...
    {
        $this->setPageHeading(MT::getLanguage()->text('mobile', 'widgets_admin_dashboard_heading'));
    ...
    {
        $this->setPageHeading(MT::getLanguage()->text('mobile', 'widgets_admin_profile_heading'));
    ...
    {
        $this->setPageHeading(MT::getLanguage()->text('mobile', 'widgets_admin_index_heading'));
        //$this->setPageHeadingIconClass('mt_ic_user');
