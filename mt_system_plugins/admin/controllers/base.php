...
class ADMIN_CTRL_Base extends ADMIN_CTRL_Abstract
{
    ...
    {
        $this->setPageHeading(MT::getLanguage()->text('admin', 'admin_dashboard'));
        $this->setPageHeadingIconClass('mt_ic_dashboard');
    ...
    public function generateSitemap()
    {
        ...
        while ( !(int) MT::getConfig()->getValue('base', 'seo_sitemap_build_finished') );
    ...
    public function dashboard( $paramList )
    {
        ...
        $customizeUrls = array(
            'customize' => MT::getRouter()->urlForRoute('admin_dashboard_customize', array('mode' => 'customize')),
            'normal' => MT::getRouter()->urlForRoute('admin_dashboard')
        );
