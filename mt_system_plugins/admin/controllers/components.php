...
class ADMIN_CTRL_Components extends ADMIN_CTRL_Abstract
{
    ...
    {
        $basePluginDir = MT::getPluginManager()->getPlugin('BASE')->getRootDir();

        $controllersTemplate = MT::getPluginManager()->getPlugin('ADMIN')->getCtrlViewDir() . 'drag_and_drop_components.html';
    ...
    {
        $this->setPageHeading(MT::getLanguage()->text('base', 'widgets_admin_dashboard_heading'));
    ...
    {
        $this->setPageHeading(MT::getLanguage()->text('base', 'widgets_admin_profile_heading'));
