...
<form method="post">
    <div style="<?= $_assign_vars['isConfigWritable'] ? 'display: none;' : ''; ?>" >
        <p>&bull; Please copy and paste this code replacing the existing one into <b>mt_includes/config.php</b> file.<br />Make sure you do not have any whitespace before and after the code.</p>
    ...
    <p style="text-align: center; color: #626262; padding-top: 19px; ">&bull; Create a cron job that runs <b>mt_cron/run.php</b> once a minute. (<a style="color:#2626ef;" target="_blank" href="http://docs.oxwall.org/install:cron"><b>?</b></a>)</p>
