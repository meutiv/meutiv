...
define('MT_DIR_ROOT', dirname(__FILE__));

require_once 'mt_includes/config.php';
require_once 'mt_libraries/securimage/securimage.php';

session_name(md5(MT_URL_HOME));
...
$img->ttf_file = 'mt_libraries/securimage/AHGBold.ttf';
