...
define('MT_USE_CONTEXT', 8); // CLI context
define('DS', DIRECTORY_SEPARATOR);
define('MT_DIR_ROOT', __DIR__ . DS);

require_once MT_DIR_ROOT . 'mt_includes' . DS . 'init.php';
require_once MT_DIR_SYSTEM_PLUGIN . 'base' . DS . 'classes' . DS . 'cli_err_output.php';

MT_ErrorManager::getInstance()->setErrorOutput(new BASE_CLASS_CliErrOutput());
...
/* @var MT_CliApplication $application */
...
$event = new MT_Event(MT_EventManager::ON_CLI_RUN);
MT::getEventManager()->trigger($event);
