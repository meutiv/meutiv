...
class TextSearchManagerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        MT::getTextSearchManager()->deleteAllEntities();
    }
    ...
    public function testDeleteEntities()
    {
        ...
        {
            MT::getTextSearchManager()->
                    addEntity($entitiy['entity_type'], $entitiy['entity_id'], $entitiy['text'], time(), $entitiy['tags']);

            MT::getTextSearchManager()->deleteEntity($entitiy['entity_type'], $entitiy['entity_id']);
        }

        // do we have entities?
        $entities = MT::getTextSearchManager()->getAllEntities(0, 2);
    ...
    public function testDeactivateAllEntities()
    {
        ...
        MT::getTextSearchManager()->deactivateAllEntities('forum_post');

        // search (we should get an empty result)
        $searchEntities = MT::getTextSearchManager()->searchEntities('forum', 0, 100);
        $this->assertInternalType('array', $searchEntities);
        $this->assertEquals(0, count($searchEntities));
        $this->assertEquals(0, MT::getTextSearchManager()->searchEntitiesCount('forum'));
    }
    ...
    public function testActivateAllEntities()
    {
        ...
        MT::getTextSearchManager()->deactivateAllEntities();

        // activate all entities
        MT::getTextSearchManager()->activateAllEntities();

        // get all entities
        $entities = MT::getTextSearchManager()->getAllEntities(0, 3);
    ...
    public function testSearchEntities()
    {
        ...
        $this->assertEquals(1, MT::getTextSearchManager()->searchEntitiesCount('forum'));
        $entities = MT::getTextSearchManager()->searchEntities('forum', 0, 100);
        ...
        $this->assertEquals(0, MT::getTextSearchManager()->searchEntitiesCount('non existing entity'));
        $entities = MT::getTextSearchManager()->searchEntities('non existing entity', 0, 100);
        $this->assertInternalType('array', $entities);
        $this->assertEquals(0, count($entities));
    }
    ...
    public function testSearchEntitiesByTags()
    {
        ...
        $entities = MT::getTextSearchManager()->searchEntities('forum', 0, 100, array(
            'forum_post'
        ));
    ...
    public function testSetEntitiesStatusByTags()
    {
        ...
        foreach ($entities as $entitiy)
        {
            ...
            // inactivate entities
            MT::getTextSearchManager()->setEntitiesStatusByTags(array(
                'tag_1',
                'tag_2',
                'tag_3'
    ...
    public function testDeleteAllEntitiesByTags()
    {
        ...
        MT::getTextSearchManager()->deleteAllEntitiesByTags(array('tag_3', 'tag_2'));

        // we should find only a one entity
        $searchEntities = MT::getTextSearchManager()->searchEntities('forum post', 0, 100);
        $this->assertInternalType('array', $searchEntities);
